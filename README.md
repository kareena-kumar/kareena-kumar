...
### 💻 Current Tech & Security Tools

**Languages & Scripting:**  
`Python` · `Bash` · `PowerShell`

**Operating Systems:**  
`Windows Server` · `Windows 11` · `Linux (Ubuntu, Kali)`

**Cloud & Infrastructure:**  
`Microsoft Azure` · `Azure VMs` · `Azure VNet` · `Azure AD` · `DNS` · `Active Directory Domain Services`

**Security & SIEM Tools:**  
`Splunk` · `Log Analysis` · `SIEM Dashboards` · `Incident Investigation`

**Networking & Identity:**  
`DHCP` · `DNS` · `IAM` · `Group Policy` · `RBAC`
